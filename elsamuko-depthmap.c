...
calcDepthmap( IplImage* cvImgLeft,
    ...
    if( change ) {
        cvFindStereoCorrespondenceGC( cvImgRight, cvImgLeft, disparityLeft, disparityRight, state, 0 );
    } else {
        cvFindStereoCorrespondenceGC( cvImgLeft, cvImgRight, disparityLeft, disparityRight, state, 0 );
    }
